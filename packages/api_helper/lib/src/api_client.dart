...
class ApiClient {
  ...
  Future<http.Response> post(
    ...
    final uri = Uri.parse('https://data2.talentpitch.co/api/homeservice/$path').replace(queryParameters: queryParameters);
  ...
  Future<http.Response> put(
    ...
    final uri = Uri.parse('https://data2.talentpitch.co/api/homeservice/$path');
